...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Pokemon Champions Wiki',
    description: 'Copyright and intellectual property information for Pokemon Champions Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Pokemon Champions Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Pokemon Champions Wiki',
      description: 'Copyright and intellectual property information for Pokemon Champions Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Pokemon Champions Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Pokemon Champions Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Pokemon Champions Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>The Pokémon Company</strong> - Creators of the Pokémon Champions game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Pokémon Champions</strong> - Trademark of the game developers</li>
              <li><strong>Pokemon Champions Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Pokemon Champions Wiki.
            </p>
            ...
            <p>
              ...
              Pokemon Champions Wiki<br />
              Email: <a href="mailto:dmca@pokemonchampions.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@pokemonchampions.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Pokemon Champions Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Pokemon Champions Wiki (pokemonchampions.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@pokemonchampions.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@pokemonchampions.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@pokemonchampions.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@pokemonchampions.wiki</a>
            </p>
            <p>
